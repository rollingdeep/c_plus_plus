...
public:
    Student(string firstName, string lastName, int id, vector<int> scores) : Person(firstName, lastName, id){ // need config
    ...
    char caculate() {
        ...
        int avg = (int) (total / this -> testScores.size());
